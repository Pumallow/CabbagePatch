...
with open("images/Data Resume.docx.pdf", "rb") as pdf_file:
    PDFByte = pdf_file.read()
scol1, scol2, scol3, scol4 = st.columns([5,1,1,5])
with scol2:
    st.download_button(label = "Resume", data = PDFByte, file_name = "Data Resume.docx.pdf")         
with scol3:
...
with col1: 
    ...
    Finished EDX - SU23: Introduction to Analytics Modeling (Score: 84 and credited in Georgia Tech's OMSA program)
    Currently enrolled in EDX - Data Analytics for Business
