...
c4 = Image.open('images/Chart4.png')
c5 = Image.open('images/Chart5.png')
dfd = Image.open('images/dfdescribe.PNG')
df = Image.open('images/df.PNG')
hc1 = Image.open('images/HC1.PNG')
hc2 = Image.open('images/HC2.PNG')
hc3 = Image.open('images/HC3.PNG')
hc4 = Image.open('images/HC4.PNG')
hd = Image.open('images/hdescribe.PNG')
ac1 = Image.open('images/AC1.PNG')
ac2 = Image.open('images/AC2.PNG')
ac3 = Image.open('images/AC3.PNG')
ac4 = Image.open('images/AC4.PNG')
ad = Image.open('images/awdescribe.PNG')
hmd = Image.open('images/HMDescribe.PNG')
lrcm = Image.open('images/lrcm.PNG')
kcm = Image.open('images/knncm.PNG')
scm = Image.open('images/svmcm.PNG')
